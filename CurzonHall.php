        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="image/CurzonHallDhaka_cover.jpg" class="d-block w-100" alt="...">
        ...
        <div class="txt">
            ...
            <div>
                <div class="container info-content">
                    <p>The quasi-Gothic red-brick Curzon Hall, erected in 1905 after the first partition of Bengal is Dhaka University's architectural masterpiece. It's a highly impressive example of the European-Mughal style of building favoured by the British. It's main hall today is used as a grand setting for university exams.</p>
                    <span id="dots"></span>
                    <span id="more">
                    <p style="color: green; font-size: 20px;">Open Time: <span style="color: black; font-size: 22px;">Sunday-Thursday</span>(8AM-5PM)</p> 
