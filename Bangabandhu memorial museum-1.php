...
<head>
    ...
    <title>Bangabandhu Memorial Museum</title>
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="image/BangabandhuMemorialMuseum_cover.jpg" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
                <h1>Bangabandhu Memorial Museum</h1>
        ...
        <div class="txt">
            ...
            <div>
                <div class="container info-content">
                    <p>After the brutal killing of Father of the Nation Bangabandhu Sheikh Mujibur Rahman along with his family members on August 15, 1975, the house was under military authority till 10th June 1981. Military ruler Ziaur Rahman did not allow any member of Bangabandhu's family to enter into the house. Even when Sheikh Hasina, daughter of Bangabandhu Sheikh Mujibur Rahman returned her motherland on 17th May, he did not allow her to enter the house. So she was forced to perform the holy religious rituals (Milad) in front of the house. The land belongs to this house purchased from public works department by installment. </p>
                    <span id="dots"></span>
                    <span id="more">
                    <p style="color: green; font-size: 20px;">Time: <span style="color: black; font-size: 22px;">Saturday – Friday</span>(9AM – 5PM)</p>
