...
<head>
    ...
    <title>National Parliament House of Bangladesh</title>
...
<body>
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="image/SangsadBhaban_cover.jpg" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
                <h1>National Parliament House of Bangladesh</h1>
        ...
        <div class="txt">
            ...
            <div>
                <div class="container info-content">
                    <p>Before its completion, the first and second Parliaments used the Old Sangsad Bhaban, which currently serves as the prime Minister’s office. Construction was started in 1961 when Bangladesh was East Pakistan, led byAyub Khan from the West Pakistan capital of Islamabad. As part of his efforts to decrease the disparity and secessionist tendencies of East Pakistan, Khan aimed to make Dhaka a second capital, with appropriate facilities for an assembly. The Bhaban consists of nine individual blocks: the eight peripheral blocks rise to a height of 110' while the central octagonal block rises to a height of 155'. All nine blocks include different groups of functional spaces and have different levels, inter-linked horizontally and vertically by corridors, lifts, stairs, light courts, and circular areas.
                    </p>
                    <span id="dots"></span>
                    <span id="more">
                    <p style="color: green; font-size: 20px;">Open Time: <span style="color: black; font-size: 22px;">Sunday-Thursday</span>(9AM-5:30PM)</p>

                    <p style="color: red; font-size: 20px;">Holiday: <span style="color: black; font-size: 22px;">Saturday & Friday</span></p>
    ...
    <section class="container map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3651.571981365971!2d90.37637461471968!3d23.7626379845834!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8abd1986c19%3A0x14e06df6918d8844!2sNational%20Parliament%20House.!5e0!3m2!1sen!2sbd!4v1605188022112!5m2!1sen!2sbd" width="1000" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe> 
    </section>
